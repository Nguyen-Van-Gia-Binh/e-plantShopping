    ...
    return (
        <div className="about-us-container">
            ...
            <p className="about-us-content">
                ...
                not only enhance the beauty of your surroundings but also contribute to a
            ...
            <p className="about-us-content">
                ...
                of the way. Feel free to explore our collection, ask questions, and let
                us help you find the perfect plant for your home or office.
            </p>
            <p className="about-us-content">
